    ...
    <div class="card mb-3 shadow">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <img class="img-fluid d-block w-100 p-2" src={{ '/images/' . $image }} style="width:100%;height:400px;"
                    alt="product image">
            </div>
                ...
                <div class="card-body">
                    ...
                    <form action="/addtocart" method="POST">
                        ...
                        <div class="d-flex justify-content-center border-top pt-5">
                            <button class="btn btn-primary w-50">Add To Cart<i class="fa fa-shopping-cart ms-1 mt-1"
