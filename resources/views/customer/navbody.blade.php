...
<div class="container py-5">
    ...
    <div class="row our-product py-5">
        ...
        <div class="col-md-4 justify-content-center d-flex py-5">
            <a href="{{ route('cd') }}"><img src="{{ asset('Images/icones/cd-player.png') }}" class="mt-3"
                    alt="img-fluid"></a>
        </div>
        <div class="col-md-4 justify-content-center d-flex py-5">
            <a href="{{ route('game') }}"><img src="{{ asset('Images/icones/game-console.png') }}"
                    class="mt-3" alt="img-fluid"></a>
        </div>
    </div>
                ...
                <form action="/emailsend" method="POST">
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Your Messages" id="floatingTextarea"
    ...
    <div class="container py-5">
        <div class="row justify-content-center text-center py-5">
            ...
            <form action="/newsletter" method="POST" class="d-flex justify-content-center py-3">
                <!--generate token -->
                @csrf
                <input type="email" class="form-control" name="email_address" placeholder="Your email address"
