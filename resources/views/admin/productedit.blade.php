    ...
    <form method="POST" action="/edit/{{$editdata->id}}" class="shadow addproduct" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="fname" aria-describedby="firstname" name="Firstname" value="{{$editdata->firstname}}" required>
                <!-- display error-->
                @error('Firstname')
                <span style="color:red">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="Main" aria-describedby="Surname" name="Surname" value="{{$editdata->mainname}}" required>
                <!-- display error-->
                @error('Surname')
                <span style="color:red">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="Title" aria-describedby="Title" name="Title" value="{{$editdata->title}}" required>
                <!-- display error-->
                @error('Title')
                <span style="color:red">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="pdp" aria-describedby="emailHelp" name="PagesDurationPEGI" value="{{$editdata->pdp}}" required>
                <!-- display error-->
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="price" aria-describedby="price" name="Price" value="{{$editdata->price}}" required>
                <!-- display error-->
                @error('Price')
                <span style="color:red">{{$message}}</span>
                @enderror
