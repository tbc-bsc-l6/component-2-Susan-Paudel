                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="email" class="form-control" name="email" id="exampleInputEmail1"
                                            ...
                                            value="{{ $fetchcustomer->email }}" disabled>
                                    </div>
                                    <!--Account Name-->
                                    <div class="mb-3 col-md-6">
                                        <label for="accountName" class="form-label">Account Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Your Name"
                                            name="name" value="{{ $fetchcustomer->name }}" required>
                                        <!--error message-->
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Your Full Address"
                                            name="location" value="{{ $fetchcustomer->location }}" required>
                                        <!--error message-->
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Your Phone number"
                                            name="phonenumber" value="{{ $fetchcustomer->phonenumber }}" required>
                                        <!--error message-->
                                        @error('phonenumber')<span class="error">{{ $message }}
                                        </span>@enderror
                                    </div>
                                    <!--New Password-->
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <!--error message-->
                                        @error('password')<span class="error">{{ $message }}
                                        </span>@enderror
                                    </div>
                                </div>
                                <!--button-->
